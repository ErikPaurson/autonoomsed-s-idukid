...
class AWNavigationNode(Node):
    ...
    def __init__(self):
        ...
        self.goal_poses.append({'x': 3822.7, 'y': 73725.7, 'z': 0.247,'w':0.969})
        self.goal_poses.append({'x': 3694.478, 'y': 73729.742, 'z': 0.862,'w':0.505})
        self.goal_poses.append({'x': 3720.8, 'y': 73743.6,'z': 0.256,'w':0.966})
