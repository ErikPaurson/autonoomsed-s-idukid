...
class CarNavigationNode(Node):
    ...
    def __init__(self):
        ...
        initial_pose.pose.pose.position.x = 3703.3
        initial_pose.pose.pose.position.y = 73763.8
                
        initial_pose.pose.pose.orientation.x = 0.0
        initial_pose.pose.pose.orientation.y = 0.0
        initial_pose.pose.pose.orientation.z = 0.238
        initial_pose.pose.pose.orientation.w = 0.971
        time.sleep(5)
        ...
        ############# [My Goal Positions] ############
        self.goal_poses.append({'x': 3822.7, 'y': 73725.7, 'xx': 0.0,'yy': 0.0,'zz': 0.247,'w':0.969})
        self.goal_poses.append({'x':3694.478 , 'y': 73796.742, 'xx': 0.0,'yy': 0.0,'zz': 0.288,'w':0.963})
        self.goal_poses.append({'x': 3720.8, 'y': 73743.6, 'xx': 0.0,'yy': 0.0,'zz': 0.256,'w':0.966})
        ############# [My Goal Positions] ############
