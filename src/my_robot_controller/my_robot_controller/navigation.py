...
class TurtleNavigationNode(Node):
    def __init__(self):
        ...
        self.goal_poses.append({'x': 4.5, 'y': 0.0, 'yaw': -90})
        self.goal_poses.append({'x': 4.5, 'y': 1.5, 'yaw': -90})
        self.goal_poses.append({'x': 0.0, 'y': 3.0, 'yaw': 0})
        self.goal_poses.append({'x': 0.0, 'y': 5.0, 'yaw': 90})
